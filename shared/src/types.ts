...
export interface Crop { id: number; parcel_id: number; variety: string; planting_date: string; status: CropStatus; estimated_harvest_date?: string; planting_density?: number; notes?: string; image_url?: string | null; created_at: string; updated_at: string; }
...
export interface Inventory { id: number; user_id: number; nombre: string; categoria: InventoryCategory; cantidad: number; unidad: InventoryUnit; fecha_adquisicion?: string; fecha_vencimiento?: string; costo_unitario?: number; notas?: string; image_url?: string | null; created_at: string; updated_at: string; }
