...
- [ ] 3.1 Create `client/src/stores/fertilizations.ts` — `useFertilizationsStore` following `useCropsStore` pattern (~110 lines)
- [ ] 3.2 Create `client/src/stores/__tests__/fertilizations.test.ts` — ~8 vitest mock tests (~210 lines)

## Phase 4: List UI — PR #4 (~360 lines)

- [ ] 4.1 Create `client/src/features/fertilizations/components/FertilizationTable.tsx` (~160 lines)
- [ ] 4.2 Create `client/src/features/fertilizations/FertilizationListPage.tsx` (~70 lines)
- [ ] 4.3 Create `client/src/features/fertilizations/__tests__/FertilizationListPage.test.tsx` — ~4 RTL tests (~120 lines)

## Phase 5: Forms, Detail & Integration — PR #5 (~395 lines)

- [ ] 5.1 Create `client/src/features/fertilizations/components/FertilizationForm.tsx` (~200 lines)
- [ ] 5.2 Create `client/src/features/fertilizations/FertilizationFormPage.tsx` — create + edit modes (~85 lines)
- [ ] 5.3 Create `client/src/features/fertilizations/FertilizationDetailPage.tsx` with DeleteDialog (~100 lines)
- [ ] 5.4 Add 4 fertilization routes to `client/src/App.tsx` under AuthGuard (~10 lines)
- [ ] 5.5 Add "Fertilizaciones" NavLink to `client/src/shared/layout/Sidebar.tsx` after Cultivos (~7 lines)
